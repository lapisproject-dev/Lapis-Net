...
end-to-end messaging (X3DH/Double Ratchet/MLS calls, V0.8), and mail
encryption, threading, attachments, and spam protection (V0.9.2–V0.9.4 — the
V0.9.1 envelope/body format and GossipSub inbox propagation are implemented,
see `lapis-net-mail` below).
