...
gates" section. **A browser UI for direct messages is explicitly NOT built
this wave**: `DmAcceptanceCheck`, `DmAcceptedContacts`, and
`DmAttachmentFetcher` are complete, independently tested building blocks
with no production caller in this repo yet.
